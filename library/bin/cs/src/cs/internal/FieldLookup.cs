...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{67, 97, 98, 105, 109, 120, 121, 22420, 22421, 22860, 23089, 23090, 23515, 24650, 24651, 26809, 26810, 27032, 27033, 4745537, 4846113, 4899635, 4996429, 5047259, 5144726, 5343647, 5393365, 5442204, 5594513, 5594516, 5741474, 5745024, 5890653, 18241066, 35289056, 57476627, 66083509, 67859554, 76061764, 78945784, 87367608, 108830952, 117221091, 142151465, 142301684, 150033752, 157425153, 190509036, 205043939, 221637784, 226931207, 261031087, 276887687, 288963157, 302979532, 312752480, 319595299, 326828109, 328878574, 334695532, 343868310, 356482751, 359333139, 397693302, 399079674, 404153790, 407283053, 452737314, 475510357, 480756972, 501039929, 519963165, 520590566, 562859421, 572311959, 585253843, 630156697, 691375679, 746281503, 784433846, 796121503, 827137974, 834174833, 859666569, 863972113, 868895842, 878103594, 883147691, 890433348, 922179759, 922671056, 925807559, 929491738, 931940005, 946786476, 958884033, 958901218, 995006396, 1001867384, 1040027997, 1067353468, 1080633367, 1080633368, 1103412149, 1113806378, 1113806382, 1117325906, 1117622043, 1154634328, 1158124837, 1169897582, 1169898256, 1170169305, 1177754921, 1181037546, 1183237552, 1204816148, 1214452573, 1224700491, 1224901875, 1225098545, 1228056441, 1239190582, 1247875546, 1257164128, 1257939113, 1273207865, 1280549057, 1280845662, 1281091404, 1282943179, 1285439585, 1292432058, 1295590426, 1309411264, 1313416818, 1323686069, 1335767095, 1336745990, 1338143777, 1348037855, 1352786672, 1358471724, 1361165170, 1361165171, 1361165172, 1361165173, 1395555037, 1398464674, 1431819701, 1436822557, 1460447810, 1463469014, 1487639718, 1491020124, 1493492809, 1532710347, 1537812987, 1538593522, 1547539107, 1576149820, 1611958057, 1620824029, 1621420777, 1623148745, 1639293562, 1648581351, 1657829882, 1676395188, 1677065160, 1705629508, 1720426538, 1724402127, 1762364291, 1768014458, 1768617329, 1786263357, 1788062977, 1788958807, 1809768043, 1811518261, 1811559640, 1825849507, 1830310359, 1835249534, 1843764510, 1869208782, 1910180171, 1915412854, 1916009602, 1917859911, 1932812122, 1937159360, 1937751687, 1943520232, 1962040800, 1963056639, 1981972957, 2013228622, 2022294396, 2025055113, 2026819210, 2026820549, 2048392659, 2054707467, 2065762231, 2082007393, 2082663554, 2083206470, 2097154445, 2113708439, 2117141633, 2117167096, 2123426830, 2127021138, 2139647042, 2144877367};
		
		protected static string[] fields = new string[]{"C", "a", "b", "i", "m", "x", "y", "dx", "dy", "fr", "gx", "gy", "id", "nx", "ny", "x1", "x2", "y1", "y2", "__a", "add", "buf", "dir", "end", "get", "key", "len", "map", "pop", "pos", "set", "sub", "vel", "limType", "leftExtended", "getEnumConstructs", "addLine", "start", "remove", "__previousException", "filter", "repell", "satisfy", "classString", "resize", "focusPoint", "limValue", "enabledFrame", "contactPoints", "__nativeException", "getString", "get_length", "prevLine", "struct", "methodName", "get_native", "set_length", "airPoints", "iterator", "indent", "dateUTC", "object", "lastIndexOf", "constraints", "friction", "replacer", "hasNext", "reverse", "broken", "nOccupied", "insert", "velocity", "length", "keyList", "native", "angle", "array", "deserialize", "contains", "pretty", "invincible", "noConstrain", "value", "trackList", "__nativeStack", "accConst", "fieldsString", "threshold", "renderRider", "bones", "cachedIndex", "endurance", "restLength", "camera", "toString", "attract", "gfxEnd", "hashes", "tangible", "intangible", "splice", "accx", "accy", "copy", "data", "date", "startPos", "startVel", "removeLine", "disableFrame", "info", "init", "breakable", "__skipStack", "join", "colors", "concat", "clone", "name", "next", "nind", "enumConstructor", "set_angle", "push", "keyValueIterator", "position", "current", "size", "sort", "step", "quicksort", "loadSOLTrack", "type", "scarfAnchor", "checkLimits", "vals", "rightExtended", "constrain", "crashed", "collidable", "write", "spliceVoid", "zone", "point_a", "point_b", "point_c", "point_d", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "__ownStack", "x_vel", "y_grav", "setRestLength", "calculateConstants", "concatNative", "nBuckets", "limStart", "className", "quote", "set_crashed", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "fileName", "iterate", "intersects", "scarfPoints", "toDynamic", "get_angle", "reset", "scarves", "rider", "allEnums", "standard", "crashable", "y_vel", "limEnd", "distance", "limits", "unwrap", "customParams", "collide", "allLines", "setLim", "loadedSOL", "__get", "__set", "x_grav", "lessThan", "__hx_deleteField", "nextLine", "recursiveRead", "serialize", "lines", "lineNumber", "gravity", "upperBound", "unshift", "scale", "scarf", "_keys", "enumParameters", "set_type", "shifted", "shift", "invDistance", "header", "addChar", "enabled", "invSqrDistance", "constrainScarf", "slice", "flipped", "toSaveObject"};

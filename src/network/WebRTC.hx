...
class WebRTC 
{
	...
	public function new(isInitiator:Bool,onMessage:String->Void, ?_name:String = "openlr_default") 
	{
		#if js
	...
	function connect() 
	{
		peerConnection = Syntax.code("new RTCPeerConnection({iceServers: {0}})",iceServers);

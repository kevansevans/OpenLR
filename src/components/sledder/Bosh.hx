...
{
	static public var WHITE:Vector4 = new Vector4(1, 1, 1, 1);
	static public var BLACK:Vector4 = new Vector4(0, 0, 0, 1);
	static public var RED:Vector4 = new Vector4(1, 0, 0, 1);

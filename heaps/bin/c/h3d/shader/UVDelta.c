...
void h3d_shader_UVDelta_new(h3d__shader__UVDelta r0,double* r1,double* r2,double* r3,double* r4) {
	...
	if( r1 ) goto label$a53a0f7_4_3;
	r5 = 0.;
	goto label$a53a0f7_4_4;
	label$a53a0f7_4_3:
	r5 = *r1;
	label$a53a0f7_4_4:
	if( r2 ) goto label$a53a0f7_4_7;
	r6 = 0.;
	goto label$a53a0f7_4_8;
	label$a53a0f7_4_7:
	r6 = *r2;
	label$a53a0f7_4_8:
	if( r3 ) goto label$a53a0f7_4_11;
	r7 = 1.;
	goto label$a53a0f7_4_12;
	label$a53a0f7_4_11:
	r7 = *r3;
	label$a53a0f7_4_12:
	if( r4 ) goto label$a53a0f7_4_15;
	r8 = 1.;
	goto label$a53a0f7_4_16;
	label$a53a0f7_4_15:
	r8 = *r4;
	label$a53a0f7_4_16:

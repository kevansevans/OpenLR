...
void h3d_mat_Texture_resize(h3d__mat__Texture r0,int r1,int r2) {
	...
	r5 = 1;
	label$3bd692e_14_3:
	if( r4 >= r1 ) goto label$3bd692e_14_9;
	r7 = 1;
	r6 = r4 << r7;
	r4 = r6;
	goto label$3bd692e_14_3;
	label$3bd692e_14_9:
	if( r5 >= r2 ) goto label$3bd692e_14_15;
	r7 = 1;
	r6 = r5 << r7;
	r5 = r6;
	goto label$3bd692e_14_9;
	label$3bd692e_14_15:
	if( r4 != r1 ) goto label$3bd692e_14_17;
	if( r5 == r2 ) goto label$3bd692e_14_22;
	label$3bd692e_14_17:
	r6 = r0->flags;
	r7 = 16;
	r6 = r6 | r7;
	r0->flags = r6;
	goto label$3bd692e_14_26;
	label$3bd692e_14_22:
	r6 = r0->flags;
	r7 = -17;
	r6 = r6 & r7;
	...
	r6 = r6 & r7;
	r7 = 0;
	if( r6 != r7 ) goto label$3bd692e_14_34;
...
void h3d_mat_Texture_clear(h3d__mat__Texture r0,int r1,double* r2,vdynamic* r3) {
	...
	if( r2 ) goto label$3bd692e_15_3;
	r4 = 1.;
	goto label$3bd692e_15_4;
	label$3bd692e_15_3:
	r4 = *r2;
	label$3bd692e_15_4:
	if( r3 ) goto label$3bd692e_15_7;
	r5 = -1;
	...
	r5 = r0->width;
	r7 = 0;
	if( r5 == r7 ) goto label$3bd692e_15_14;
	r5 = r0->height;
	r7 = 0;
	if( r5 != r7 ) goto label$3bd692e_15_15;
	label$3bd692e_15_14:
	return;
	label$3bd692e_15_15:
	r5 = r0->width;
	r7 = 1;
	if( r5 != r7 ) goto label$3bd692e_15_21;
	r5 = r0->height;
	r7 = 1;
	if( r5 == r7 ) goto label$3bd692e_15_74;
	label$3bd692e_15_21:
	r10 = (h3d__$Engine)g$_h3d_Engine;
	r9 = r10->CURRENT;
	r11 = 0.;
	r12 = 1.;
	if( !(r4 < r11) ) goto label$3bd692e_15_28;
	r13 = r11;
	goto label$3bd692e_15_32;
	label$3bd692e_15_28:
	if( !(r12 < r4) ) goto label$3bd692e_15_31;
	r13 = r12;
	goto label$3bd692e_15_32;
	label$3bd692e_15_31:
	r13 = r4;
	...
	r7 = r3 ? r3->v.i : 0;
	r14 = 0;
	if( r7 >= r14 ) goto label$3bd692e_15_60;
	r7 = 0;
	r14 = ((int (*)(h3d__mat__Texture))r0->$type->vobj_proto[0])(r0);
	label$3bd692e_15_44:
	if( r7 >= r14 ) goto label$3bd692e_15_59;
	r15 = r7;
	++r7;
	...
	goto label$3bd692e_15_44;
	label$3bd692e_15_59:
	goto label$3bd692e_15_73;
	label$3bd692e_15_60:
	if( r9 == NULL ) hl_null_access();
	if( r3 ) goto label$3bd692e_15_64;
	r18 = NULL;
	goto label$3bd692e_15_66;
	label$3bd692e_15_64:
	r7 = r3 ? r3->v.i : 0;
	r18 = &r7;
	label$3bd692e_15_66:
	...
	r26 = (int)r11;
	r28 = 0;
	if( r26 >= r28 ) goto label$3bd692e_15_98;
	r27 = 0;
	r26 = r27;
	goto label$3bd692e_15_102;
	label$3bd692e_15_98:
	r28 = 255;
	if( r28 >= r26 ) goto label$3bd692e_15_102;
	r27 = 255;
	r26 = r27;
	label$3bd692e_15_102:
	r25 = (h3d__mat__$Texture)g$_h3d_mat_Texture;
	r24 = r25->nativeFormat;
	...
	switch(r27) {
		...
		case 1:
			...
			r20 = r14;
			r14 = r27;
			goto label$3bd692e_15_114;
		case 2:
			break;
	}
	label$3bd692e_15_114:
	r27 = 0;
	r28 = r0->width;
	r30 = r0->height;
	r28 = r28 * r30;
	label$3bd692e_15_118:
	if( r27 >= r28 ) goto label$3bd692e_15_143;
	++r27;
	...
	goto label$3bd692e_15_118;
	label$3bd692e_15_143:
	r27 = r3 ? r3->v.i : 0;
	r28 = 0;
	if( r27 >= r28 ) goto label$3bd692e_15_159;
	r27 = 0;
	r28 = ((int (*)(h3d__mat__Texture))r0->$type->vobj_proto[0])(r0);
	label$3bd692e_15_148:
	if( r27 >= r28 ) goto label$3bd692e_15_158;
	r30 = r27;
	++r27;
	r31 = 0;
	r18 = &r31;
	...
	goto label$3bd692e_15_148;
	label$3bd692e_15_158:
	goto label$3bd692e_15_167;
	label$3bd692e_15_159:
	r27 = 0;
	r18 = &r27;
	if( r3 ) goto label$3bd692e_15_164;
	r19 = NULL;
	goto label$3bd692e_15_166;
	label$3bd692e_15_164:
	r28 = r3 ? r3->v.i : 0;
	r19 = &r28;
	label$3bd692e_15_166:
	h3d_mat_Texture_uploadPixels(r0,r23,r18,r19);
	label$3bd692e_15_167:
	if( r23 == NULL ) hl_null_access();
	hxd_Pixels_dispose(r23);
	label$3bd692e_15_169:
	return;
}
...
void h3d_mat_Texture_checkSize(h3d__mat__Texture r0,int r1,int r2,int r3) {
	...
	r4 = r4 >> r3;
	r7 = 0;
	if( r4 != r7 ) goto label$3bd692e_16_6;
	r5 = 1;
	r4 = r5;
	label$3bd692e_16_6:
	r5 = r0->height;
	r5 = r5 >> r3;
	r8 = 0;
	if( r5 != r8 ) goto label$3bd692e_16_12;
	r7 = 1;
	r5 = r7;
	label$3bd692e_16_12:
	if( r1 != r4 ) goto label$3bd692e_16_14;
	if( r2 == r5 ) goto label$3bd692e_16_43;
	label$3bd692e_16_14:
...
void h3d_mat_Texture_checkMipMapGen(h3d__mat__Texture r0,int r1,int r2) {
	...
	int r4, r5, r6;
	r5 = 0;
	if( r1 != r5 ) goto label$3bd692e_17_21;
	r4 = r0->flags;
	r5 = 4;
	r4 = r4 & r5;
	r5 = 0;
	if( r4 == r5 ) goto label$3bd692e_17_21;
	r4 = r0->flags;
	r5 = 8;
	r4 = r4 & r5;
	r5 = 0;
	...
	r6 = 1;
	r5 = r5 - r6;
	if( r2 != r5 ) goto label$3bd692e_17_21;
	r8 = r0->mem;
...
void h3d_mat_Texture_uploadPixels(h3d__mat__Texture r0,hxd__Pixels r1,int* r2,int* r3) {
	...
	int r4, r5, r7, r8;
	if( r2 ) goto label$3bd692e_19_3;
	r4 = 0;
	goto label$3bd692e_19_4;
	label$3bd692e_19_3:
	r4 = *r2;
	label$3bd692e_19_4:
	if( r3 ) goto label$3bd692e_19_7;
	r5 = 0;
	goto label$3bd692e_19_8;
	label$3bd692e_19_7:
	r5 = *r3;
	label$3bd692e_19_8:
	h3d_mat_Texture_alloc(r0);
...
void h3d_mat_Texture_fromColor__$1(venum* r0) {
	...
	if( r4 ) goto label$3bd692e_22_7;
	r5 = NULL;
	goto label$3bd692e_22_9;
	label$3bd692e_22_7:
	r6 = r4 ? r4->v.d : 0;
	r5 = &r6;
	label$3bd692e_22_9:
...
h3d__mat__Texture h3d_mat_Texture_fromColor(int r0,vdynamic* r1) {
	...
	r6 = (int)r2;
	r9 = 0;
	if( r6 >= r9 ) goto label$3bd692e_23_14;
	r8 = 0;
	r6 = r8;
	goto label$3bd692e_23_18;
	label$3bd692e_23_14:
	r9 = 255;
	if( r9 >= r6 ) goto label$3bd692e_23_18;
	r8 = 255;
	r6 = r8;
	label$3bd692e_23_18:
	r9 = 16777215;
	...
	if( !r13 ) goto label$3bd692e_23_30;
	return r13;
	label$3bd692e_23_30:
	...
	if( r1 ) goto label$3bd692e_23_39;
	r17 = NULL;
	goto label$3bd692e_23_41;
	label$3bd692e_23_39:
	r2 = r1 ? r1->v.d : 0;
	r17 = &r2;
	label$3bd692e_23_41:
...
h3d__mat__Texture h3d_mat_Texture_defaultCubeTexture() {
	...
	if( !r6 ) goto label$3bd692e_25_10;
	return r6;
	label$3bd692e_25_10:
...
void h3d_mat_Texture_new(h3d__mat__Texture r0,int r1,int r2,hl__types__ArrayObj r3,venum* r4) {
	...
	r9 = r6->mem;
	r0->mem = r9;
	if( r4 ) goto label$3bd692e_26_11;
	...
	r12 = 0;
	r0->flags = r12;
	if( !r3 ) goto label$3bd692e_26_41;
	r13 = 0;
	label$3bd692e_26_21:
	if( r3 == NULL ) hl_null_access();
	r15 = r3->length;
	if( r13 >= r15 ) goto label$3bd692e_26_41;
	r15 = r3->length;
	if( ((unsigned)r13) < ((unsigned)r15) ) goto label$3bd692e_26_29;
	r16 = NULL;
	goto label$3bd692e_26_32;
	label$3bd692e_26_29:
	r18 = r3->array;
	...
	r14 = r14 | r15;
	r0->flags = r14;
	goto label$3bd692e_26_21;
	label$3bd692e_26_41:
	r13 = 1;
	r14 = 1;
	label$3bd692e_26_43:
	if( r13 >= r1 ) goto label$3bd692e_26_49;
	r19 = 1;
	r15 = r13 << r19;
	r13 = r15;
	goto label$3bd692e_26_43;
	label$3bd692e_26_49:
	if( r14 >= r2 ) goto label$3bd692e_26_55;
	r19 = 1;
	r15 = r14 << r19;
	r14 = r15;
	goto label$3bd692e_26_49;
	label$3bd692e_26_55:
	if( r13 != r1 ) goto label$3bd692e_26_57;
	if( r14 == r2 ) goto label$3bd692e_26_61;
	label$3bd692e_26_57:
	r15 = r0->flags;
	r19 = 16;
	r15 = r15 | r19;
	...
	r15 = r15 & r19;
	r19 = 0;
	if( r15 == r19 ) goto label$3bd692e_26_68;
	r20 = &cl$0;
	r0->realloc = r20;
	label$3bd692e_26_68:
	r0->width = r1;
	...
	r15 = r15 & r19;
	r19 = 0;
	if( r15 == r19 ) goto label$3bd692e_26_77;
	r21 = (venum*)g$h3d_mat_MipMap_Nearest;
	goto label$3bd692e_26_78;
	label$3bd692e_26_77:
	...
	r15 = r15 & r19;
	r19 = 0;
	if( r15 != r19 ) goto label$3bd692e_26_93;
	h3d_mat_Texture_alloc(r0);
	label$3bd692e_26_93:
	return;
}

...
void h3d_pass_Default_setupShaders(h3d__pass__Default r0,h3d__pass__PassList r1) {
	...
	r4 = r1->current;
	label$3752213_6_3:
	if( !r4 ) goto label$3752213_6_139;
	r5 = r4;
	if( r4 == NULL ) hl_null_access();
	r6 = r4->next;
	r4 = r6;
	...
	r18 = r19->textures;
	if( r18 ) goto label$3752213_6_58;
	r20 = 0;
	r5->texture = r20;
	goto label$3752213_6_138;
	label$3752213_6_58:
	r14 = r0->manager;
	if( r18 == NULL ) hl_null_access();
	r21 = r18->perObjectGlobal;
	if( !r21 ) goto label$3752213_6_102;
	if( r14 == NULL ) hl_null_access();
	r13 = r14->globals;
	...
	if( r22 ) goto label$3752213_6_86;
	...
	r28 = 17;
	if( r20 != r28 ) goto label$3752213_6_94;
	r20 = ((hxsl_Type_TChannel*)r27)->p0;
	r30 = true;
	goto label$3752213_6_95;
	label$3752213_6_94:
	r30 = false;
	label$3752213_6_95:
	if( !r30 ) goto label$3752213_6_99;
	if( r22 == NULL ) hl_null_access();
	r24 = (vdynamic*)hl_dyn_getp((vdynamic*)r22,-18823348/*texture*/,&t$_dyn);
	goto label$3752213_6_100;
	label$3752213_6_99:
	r24 = r22;
	label$3752213_6_100:
	r31 = (h3d__mat__Texture)hl_dyn_castp(&r24,&t$_dyn,&t$h3d_mat_Texture);
	goto label$3752213_6_131;
	label$3752213_6_102:
	r20 = r18->instance;
	label$3752213_6_103:
	--r20;
	r28 = 0;
	if( r28 >= r20 ) goto label$3752213_6_111;
	if( r9 == NULL ) hl_null_access();
	r32 = r9->next;
	r9 = r32;
	goto label$3752213_6_103;
	label$3752213_6_111:
	if( r9 == NULL ) hl_null_access();
	r33 = r9->s;
	...
	if( r22 ) goto label$3752213_6_130;
	r29 = false;
	if( !r29 ) goto label$3752213_6_130;
	...
	label$3752213_6_131:
	if( r6 == NULL ) hl_null_access();
	if( r31 ) goto label$3752213_6_135;
	r20 = 0;
	goto label$3752213_6_137;
	label$3752213_6_135:
...
void h3d_pass_Default_draw(h3d__pass__Default r0,h3d__pass__PassList r1,vclosure* r2) {
	...
	if( r7 == NULL ) hl_null_access();
	r10 = r7->length;
	if( r6 >= r10 ) goto label$3752213_8_31;
	r10 = r7->length;
	if( ((unsigned)r6) < ((unsigned)r10) ) goto label$3752213_8_16;
	r11 = NULL;
	goto label$3752213_8_19;
	label$3752213_8_16:
	r12 = r7->array;
	...
	r4 = r1->current;
	label$3752213_8_50:
	if( !r4 ) goto label$3752213_8_155;
	r19 = r4;
	if( r4 == NULL ) hl_null_access();
	r20 = r4->next;
	r4 = r20;
	...
	if( !r23 ) goto label$3752213_8_86;
	r22 = r19->obj;
	if( r22 == NULL ) hl_null_access();
	...
	label$3752213_8_86:
	r25 = r19->shader;
	if( r18 == r25 ) goto label$3752213_8_126;
	r24 = r19->shader;
	r18 = r24;
	r8 = r0->ctx;
	if( r8 == NULL ) hl_null_access();
	...
	if( r17 ) goto label$3752213_8_105;
	r8 = r0->ctx;
	if( r8 == NULL ) hl_null_access();
	...
	if( r23 ) goto label$3752213_8_153;
	r15 = r0->manager;
	if( r15 == NULL ) hl_null_access();
	r24 = r19->shader;
	r31 = r19->shaders;

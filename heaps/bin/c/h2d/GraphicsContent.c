...
void h2d_GraphicsContent_flush(h2d__GraphicsContent);
...
void h2d_GraphicsContent_new(h2d__GraphicsContent r0) {
...
bool h2d_GraphicsContent_next(h2d__GraphicsContent r0) {
	vvirtual *r8;
	...
	r1 = r1 >> r3;
	r5 = 32768;
	if( r1 >= r5 ) goto label$ce6c8cf_2_9;
	r6 = false;
	return r6;
	label$ce6c8cf_2_9:
	r7 = r0->buffers;
	...
	r12 = 0;
	if( r12 >= r3 ) goto label$ce6c8cf_2_39;
	r12 = r2->length;
	if( r12 >= r3 ) goto label$ce6c8cf_2_39;
	r12 = 1;
	r5 = r3 - r12;
	...
	r14 = (float)r13;
	r12 = r2->length;
	if( ((unsigned)r5) < ((unsigned)r12) ) goto label$ce6c8cf_2_35;
	...
	*(float*)(r15 + r12) = r14;
	...
	r16 = 0;
	if( r16 >= r5 ) goto label$ce6c8cf_2_59;
	r16 = r9->length;
	if( r16 >= r5 ) goto label$ce6c8cf_2_59;
	r16 = 1;
	r12 = r5 - r16;
	...
	r16 = (int)r17;
	r18 = r9->length;
	if( ((unsigned)r12) < ((unsigned)r18) ) goto label$ce6c8cf_2_55;
...
void h2d_GraphicsContent_alloc(h2d__GraphicsContent r0,h3d__Engine r1) {
	vvirtual *r14;
	...
	r3 = r4->length;
	r5 = 0;
	if( r5 < r3 ) goto label$ce6c8cf_3_6;
	return;
	label$ce6c8cf_3_6:
	...
	r13 = r12->length;
	if( r3 >= r13 ) goto label$ce6c8cf_3_56;
	r13 = r12->length;
	if( ((unsigned)r3) < ((unsigned)r13) ) goto label$ce6c8cf_3_27;
	r14 = NULL;
	goto label$ce6c8cf_3_30;
	label$ce6c8cf_3_27:
	r15 = r12->array;
	...
	if( !r8 ) goto label$ce6c8cf_3_38;
	r8 = hl_vfields(r14)[3] ? (*(h3d__Buffer*)(hl_vfields(r14)[3])) : (h3d__Buffer)hl_dyn_getp(r14->value,239726983/*vbuf*/,&t$h3d_Buffer);
	if( r8 == NULL ) hl_null_access();
	r16 = h3d_Buffer_isDisposed(r8);
	if( !r16 ) goto label$ce6c8cf_3_44;
	label$ce6c8cf_3_38:
	if( r7 == NULL ) hl_null_access();
	...
	if( !r10 ) goto label$ce6c8cf_3_50;
	r10 = hl_vfields(r14)[1] ? (*(h3d__Indexes*)(hl_vfields(r14)[1])) : (h3d__Indexes)hl_dyn_getp(r14->value,95562612/*ibuf*/,&t$h3d_Indexes);
	if( r10 == NULL ) hl_null_access();
	r16 = h3d_Indexes_isDisposed(r10);
	if( !r16 ) goto label$ce6c8cf_3_55;
	label$ce6c8cf_3_50:
	if( r7 == NULL ) hl_null_access();
...
void h2d_GraphicsContent_render(h2d__GraphicsContent r0,h3d__Engine r1) {
	vvirtual *r9;
	hl__types__ArrayObj r7;
	hl__types__ArrayBytes_hl_UI16 r4;
	h3d__Buffer r11;
	...
	r3 = r4->length;
	r5 = 0;
	if( r5 < r3 ) goto label$ce6c8cf_4_6;
	return;
	label$ce6c8cf_4_6:
	h2d_GraphicsContent_flush(r0);
	r3 = 0;
	r7 = r0->buffers;
	label$ce6c8cf_4_9:
	if( r7 == NULL ) hl_null_access();
	r8 = r7->length;
	if( r3 >= r8 ) goto label$ce6c8cf_4_29;
	r8 = r7->length;
	if( ((unsigned)r3) < ((unsigned)r8) ) goto label$ce6c8cf_4_17;
	r9 = NULL;
	goto label$ce6c8cf_4_20;
	label$ce6c8cf_4_17:
	r10 = r7->array;
	...
	goto label$ce6c8cf_4_9;
	label$ce6c8cf_4_29:
	h3d_prim_Primitive_render(((h3d__prim__Primitive)r0),r1);
	return;
}

void h2d_GraphicsContent_flush(h2d__GraphicsContent r0) {
	...
	int r8, r9;
	r2 = r0->buffer;
	if( !r2 ) goto label$ce6c8cf_5_6;
	r2 = r0->buffer;
	if( r2 == NULL ) hl_null_access();
	r3 = h3d_Buffer_isDisposed(r2);
	if( !r3 ) goto label$ce6c8cf_5_10;
	label$ce6c8cf_5_6:
	r5 = (h3d__$Engine)g$_h3d_Engine;
	r4 = r5->CURRENT;
	((void (*)(h2d__GraphicsContent,h3d__Engine))r0->$type->vobj_proto[1])(r0,r4);
	goto label$ce6c8cf_5_34;
	label$ce6c8cf_5_10:
	r6 = hxd_impl_Allocator_get();
	r3 = r0->bufferDirty;
	if( !r3 ) goto label$ce6c8cf_5_23;
...
void h2d_GraphicsContent_dispose(h2d__GraphicsContent r0) {
	vvirtual *r5;
	...
	r4 = r3->length;
	if( r1 >= r4 ) goto label$ce6c8cf_6_32;
	r4 = r3->length;
	if( ((unsigned)r1) < ((unsigned)r4) ) goto label$ce6c8cf_6_10;
	r5 = NULL;
	goto label$ce6c8cf_6_13;
	label$ce6c8cf_6_10:
	r7 = r3->array;
	r6 = ((vdynamic**)(r7 + 1))[r1];
	...
	if( !r10 ) goto label$ce6c8cf_6_27;
	r9 = hxd_impl_Allocator_get();
	if( r9 == NULL ) hl_null_access();
	r10 = hl_vfields(r5)[1] ? (*(h3d__Indexes*)(hl_vfields(r5)[1])) : (h3d__Indexes)hl_dyn_getp(r5->value,95562612/*ibuf*/,&t$h3d_Indexes);
	...
	goto label$ce6c8cf_6_2;
	label$ce6c8cf_6_32:
	r8 = r0->buffer;
	if( !r8 ) goto label$ce6c8cf_6_40;
	r9 = hxd_impl_Allocator_get();
	if( r9 == NULL ) hl_null_access();
	r8 = r0->buffer;
	hxd_impl_Allocator_disposeBuffer(r9,r8);
	...
	label$ce6c8cf_6_40:
	r10 = r0->indexes;
	if( !r10 ) goto label$ce6c8cf_6_48;
	r9 = hxd_impl_Allocator_get();
	if( r9 == NULL ) hl_null_access();
	r10 = r0->indexes;
	hxd_impl_Allocator_disposeIndexBuffer(r9,r10);
...
void h2d_GraphicsContent_clear(h2d__GraphicsContent r0) {
	...
	r7 = (float)r6;
	r5 = r3->length;
	if( ((unsigned)r4) < ((unsigned)r5) ) goto label$ce6c8cf_7_15;
	...
	*(float*)(r8 + r5) = r7;
	...
	hl_types_ArrayBytes_hl_UI16_new(r9);
	r10 = 0;
	if( r10 >= r4 ) goto label$ce6c8cf_7_39;
	r10 = r9->length;
	if( r10 >= r4 ) goto label$ce6c8cf_7_39;
	r10 = 1;
	r5 = r4 - r10;
	...
	r10 = (int)r11;
	r12 = r9->length;
	if( ((unsigned)r5) < ((unsigned)r12) ) goto label$ce6c8cf_7_35;

...
void h2d_TextInput_new__$1(h2d__TextInput r0,hxd__Event r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r4 = r1->cancel;
	if( r4 ) goto label$3fda7ba_2_50;
	r5 = r1->button;
	r6 = 0;
	if( r5 != r6 ) goto label$3fda7ba_2_50;
	r7 = r0->interactive;
	if( r7 == NULL ) hl_null_access();
	r4 = h2d_Interactive_hasFocus(r7);
	if( r4 ) goto label$3fda7ba_2_27;
	r8 = (venum*)g$hxd_EventKind_EFocus;
	r1->kind = r8;
	r3 = r0->onFocus;
	if( r3 == NULL ) hl_null_access();
	r3->hasValue ? ((void (*)(vdynamic*,hxd__Event))r3->fun)((vdynamic*)r3->value,r1) : ((void (*)(hxd__Event))r3->fun)(r1);
	r8 = (venum*)g$hxd_EventKind_EPush;
	r1->kind = r8;
	r4 = r1->cancel;
	if( !r4 ) goto label$3fda7ba_2_24;
	return;
	label$3fda7ba_2_24:
	r7 = r0->interactive;
	if( r7 == NULL ) hl_null_access();
	h2d_Interactive_focus(r7);
	label$3fda7ba_2_27:
	r9 = 0.;
	r0->cursorBlink = r9;
	r9 = r1->relX;
	r10 = r1->relY;
	r5 = h2d_TextInput_textPos(r0,r9,r10);
	r0->cursorIndex = r5;
	r11 = NULL;
	...
	r15 = h2d_Object_getScene(((h2d__Object)r0));
	if( r15 == NULL ) hl_null_access();
	r16 = hl_alloc_enum(&t$ctx_ac38764,0);
	((Enumt$ctx_ac38764*)r16)->p0 = (h2d__TextInput)r0;
	((Enumt$ctx_ac38764*)r16)->p1 = (int)r5;
	((Enumt$ctx_ac38764*)r16)->p2 = (h2d__col__Point)r12;
	((Enumt$ctx_ac38764*)r16)->p3 = (h2d__Scene)r15;
	r3 = hl_alloc_closure_ptr(&t$fun_731869e,h2d_TextInput_new__$2,r16);
	r17 = NULL;
	r18 = NULL;
	h2d_Scene_startCapture(r15,r3,r17,r18);
	label$3fda7ba_2_50:
	return;
}

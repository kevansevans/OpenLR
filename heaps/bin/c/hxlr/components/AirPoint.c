...
void hxlr_components_AirPoint_new(hxlr__components__AirPoint r0,double r1,double r2,double r3) {
	double r5, r7;
	double *r6, *r8, *r9;
	r5 = r1;
	r6 = &r5;
	...
	r8 = &r7;
	r9 = NULL;
	hxlr_components_ContactPoint_new(((hxlr__components__ContactPoint)r0),r6,r8,r9);
	r0->airFriction = r3;
	return;
}

void hxlr_components_AirPoint_iterate(hxlr__components__AirPoint r0,h2d__col__Point r1) {
	h2d__col__Point r2, r4, r6, r8, r11;
	double r5, r7, r12, r13, r14;
	double *r9, *r10;
	if( r1 ) goto label$babe638_2_3;
	r2 = r0->gravity;
	goto label$babe638_2_4;
	label$babe638_2_3:
	r2 = r1;
	label$babe638_2_4:
	r4 = r0->dir;

...
void hxlr_components_anchor_ContactPoint_new(hxlr__components__anchor__ContactPoint r0,double* r1,double* r2,double* r3) {
	h2d__col__Point r7;
	double r4, r5, r6, r8, r9;
	if( r1 ) goto label$fd4f05c_1_3;
	r4 = 0.;
	goto label$fd4f05c_1_4;
	label$fd4f05c_1_3:
	r4 = *r1;
	label$fd4f05c_1_4:
	if( r2 ) goto label$fd4f05c_1_7;
	r5 = 0.;
	goto label$fd4f05c_1_8;
	label$fd4f05c_1_7:
	r5 = *r2;
	label$fd4f05c_1_8:
	if( r3 ) goto label$fd4f05c_1_11;
	r6 = 0.;
	goto label$fd4f05c_1_12;
	label$fd4f05c_1_11:
	r6 = *r3;
	label$fd4f05c_1_12:
...
void hxlr_components_anchor_ContactPoint_iterate(hxlr__components__anchor__ContactPoint r0,h2d__col__Point r1) {
	h2d__col__Point r2, r4, r6, r8, r11;
	double r5, r7, r12, r13, r14;
	double *r9, *r10;
	if( r1 ) goto label$fd4f05c_2_3;
	r2 = r0->gravity;
	goto label$fd4f05c_2_4;
	label$fd4f05c_2_3:
	r2 = r1;
	label$fd4f05c_2_4:
	r4 = r0->dir;
...
vvirtual* hxlr_components_anchor_ContactPoint_serialize(hxlr__components__anchor__ContactPoint r0) {
	vvirtual *r1;
	h2d__col__Point r2;
...
void hxlr_components_anchor_ContactPoint_deserialize(hxlr__components__anchor__ContactPoint r0,vvirtual* r1) {
	h2d__col__Point r2;

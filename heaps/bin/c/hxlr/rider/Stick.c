...
bool hxlr_rider_Stick_set_type__$1(vclosure* r0,bool r1) {
	vdynamic *r2;
...
void hxlr_rider_Stick_satisfy(hxlr__rider__Stick r0,vdynamic* r1) {
	bool r3, r6;
	hxlr__rider__RiderBase r7;
	vclosure *r4;
	vdynamic *r5;
	r3 = r0->enabled;
	if( r3 ) goto label$d68056b_2_3;
	return;
	label$d68056b_2_3:
	r4 = r0->constrain;
	...
	r6 = r0->breakable;
	if( !r6 ) goto label$d68056b_2_10;
	r0->broken = r3;
	label$d68056b_2_10:
	r6 = r0->crashable;
	if( !r6 ) goto label$d68056b_2_16;
	r7 = r0->rider;
	if( r7 == NULL ) hl_null_access();
	r6 = hxlr_rider_RiderBase_set_crashed(r7,r3);
	r5 = hl_alloc_dynbool(r6);
	label$d68056b_2_16:
	return;
}

bool hxlr_rider_Stick_noConstrain(hxlr__rider__Stick r0,vdynamic* r1) {
	bool r2;
	r2 = r1 ? r1->v.b : 0;
	return r2;
}

bool hxlr_rider_Stick_standard(hxlr__rider__Stick r0,vdynamic* r1) {
	bool r10;
	hxlr__rider__RiderBase r11;
	h2d__col__Point r3;
	...
	r7 = 0.;
	r9 = 0.;
	if( r6 == r9 ) goto label$d68056b_4_35;
	r9 = r0->restLength;
	r8 = r6 - r9;
	r8 = r8 / r6;
	r9 = 0.5;
	...
	label$d68056b_4_35:
	r10 = r0->crashable;
	if( r10 ) goto label$d68056b_4_39;
	r10 = r0->breakable;
	if( !r10 ) goto label$d68056b_4_51;
	label$d68056b_4_39:
	r11 = r0->rider;
	...
	if( r10 ) goto label$d68056b_4_51;
	r9 = r0->endurance;
	if( r9 < r7 ) goto label$d68056b_4_49;
	r10 = r1 ? r1->v.b : 0;
	if( r10 ) goto label$d68056b_4_49;
	r10 = r0->broken;
	if( !r10 ) goto label$d68056b_4_51;
	label$d68056b_4_49:
	r10 = true;
...
bool hxlr_rider_Stick_repell(hxlr__rider__Stick r0,vdynamic* r1) {
	bool r10;
	hxlr__rider__RiderBase r11;
	h2d__col__Point r3;
	hxlr__rider__ContactPoint r4;
	...
	r6 = hl_math_sqrt(r6);
	r8 = r0->restLength;
	if( !(r6 < r8) ) goto label$d68056b_5_83;
	r7 = 0.;
	r9 = 0.;
	if( r6 == r9 ) goto label$d68056b_5_37;
	r9 = r0->restLength;
	r8 = r6 - r9;
	r8 = r8 / r6;
	r9 = 0.5;
	...
	label$d68056b_5_37:
	r10 = r0->crashable;
	if( r10 ) goto label$d68056b_5_41;
	r10 = r0->breakable;
	if( !r10 ) goto label$d68056b_5_53;
	label$d68056b_5_41:
	r11 = r0->rider;
	if( r11 == NULL ) hl_null_access();
	r10 = r11->invincible;
	if( r10 ) goto label$d68056b_5_53;
	r9 = r0->endurance;
	if( r9 < r7 ) goto label$d68056b_5_51;
	r10 = r1 ? r1->v.b : 0;
	if( r10 ) goto label$d68056b_5_51;
	r10 = r0->broken;
	if( !r10 ) goto label$d68056b_5_53;
	label$d68056b_5_51:
	r10 = true;
...
bool hxlr_rider_Stick_scarf(hxlr__rider__Stick r0,vdynamic* r1) {
	bool r13;
	h2d__col__Point r3;
	hxlr__rider__ContactPoint r4;
	...
	r9 = NULL;
	r8 = 0.;
	if( r6 != r8 ) goto label$d68056b_6_33;
	r10 = 0;
	r7 = (double)r10;
	r11 = hl_alloc_dynamic(&t$_f64);
	r11->v.d = r7;
	goto label$d68056b_6_39;
	label$d68056b_6_33:
	r8 = r0->restLength;
	r7 = r6 - r8;
	r7 = r7 / r6;
...
void hxlr_rider_Stick_setRestLength(hxlr__rider__Stick r0) {
	h2d__col__Point r2;
...
void hxlr_rider_Stick_new(hxlr__rider__Stick r0,hxlr__rider__ContactPoint r1,hxlr__rider__ContactPoint r2,venum* r3,hxlr__rider__RiderBase r4) {
	...
	r0->a = r1;
	r0->b = r2;
	r6 = hxlr_rider_Stick_set_type(r0,r3);
	r0->rider = r4;

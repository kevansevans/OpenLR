...
void components_managers_Grid_register(components__managers__Grid r0,components__lines__LineBase r1) {
	...
	label$e6f4f97_1_75:
	r18 = true;
	if( !r18 ) goto label$e6f4f97_1_191;
	if( r4 == NULL ) hl_null_access();
	r13 = hl_vfields(r4)[2] ? (*(int*)(hl_vfields(r4)[2])) : (int)hl_dyn_geti(r4->value,120/*x*/,&t$_i32);
	r14 = 0;
	...
	if( r13 < r10 ) goto label$e6f4f97_1_190;
	r13 = hl_vfields(r9)[2] ? (*(int*)(hl_vfields(r9)[2])) : (int)hl_dyn_geti(r9->value,120/*x*/,&t$_i32);
	if( r2 < r13 ) goto label$e6f4f97_1_190;
	r13 = hl_vfields(r9)[3] ? (*(int*)(hl_vfields(r9)[3])) : (int)hl_dyn_geti(r9->value,121/*y*/,&t$_i32);
	if( r13 < r12 ) goto label$e6f4f97_1_190;
	r13 = hl_vfields(r9)[3] ? (*(int*)(hl_vfields(r9)[3])) : (int)hl_dyn_geti(r9->value,121/*y*/,&t$_i32);
	if( r11 < r13 ) goto label$e6f4f97_1_190;
	r13 = hl_vfields(r9)[2] ? (*(int*)(hl_vfields(r9)[2])) : (int)hl_dyn_geti(r9->value,120/*x*/,&t$_i32);
...
void components_managers_Grid_storeLine(components__managers__Grid r0,components__lines__LineBase r1,int r2,int r3) {
	...
	r12 = hl_to_virtual(&t$vrt_f6fd8f3,(vdynamic*)r10);
	if( r12 ) goto label$e6f4f97_3_44;
	r12 = hl_alloc_virtual(&t$vrt_f6fd8f3);
	...
	r19 = hl_alloc_array(r20,r5);
	r18 = hl_types_ArrayObj_alloc(r19);
	if( hl_vfields(r12)[2] ) *(hl__types__ArrayObj*)(hl_vfields(r12)[2]) = (hl__types__ArrayObj)r18; else hl_dyn_setp(r12->value,332491895/*nonColliders*/,&t$hl_types_ArrayObj,r18);
	r11 = r0->registry;
	if( r11 == NULL ) hl_null_access();
	...
	r18 = hl_vfields(r12)[0] ? (*(hl__types__ArrayObj*)(hl_vfields(r12)[0])) : (hl__types__ArrayObj)hl_dyn_getp(r12->value,233152173/*allLines*/,&t$hl_types_ArrayObj);
	...
	switch(r5) {
		...
		case 1:
			...
			r12 = hl_to_virtual(&t$vrt_f6fd8f3,(vdynamic*)r10);
			if( r12 == NULL ) hl_null_access();
			r18 = hl_vfields(r12)[1] ? (*(hl__types__ArrayObj*)(hl_vfields(r12)[1])) : (hl__types__ArrayObj)hl_dyn_getp(r12->value,-149576751/*hittable*/,&t$hl_types_ArrayObj);
			if( r18 == NULL ) hl_null_access();
			r23 = r1->id;
			r5 = r23 ? r23->v.i : 0;
			r24 = r18->length;
			if( ((unsigned)r5) < ((unsigned)r24) ) goto label$e6f4f97_3_75;
		...
		case 2:
			...
			r12 = hl_to_virtual(&t$vrt_f6fd8f3,(vdynamic*)r10);
			if( r12 == NULL ) hl_null_access();
			r18 = hl_vfields(r12)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r12)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r12->value,332491895/*nonColliders*/,&t$hl_types_ArrayObj);
			if( r18 == NULL ) hl_null_access();
			r5 = hl_types_ArrayObj_push(r18,((vdynamic*)r1));
	}
	label$e6f4f97_3_86:
	r18 = r1->keyList;
	if( r18 == NULL ) hl_null_access();
	r5 = hl_types_ArrayObj_push(r18,((vdynamic*)r4));
	return;
}
...
void components_managers_Grid_unregister(components__managers__Grid r0,components__lines__LineBase r1) {
	...
	r14 = hl_to_virtual(&t$vrt_f6fd8f3,(vdynamic*)r4);
	...
	switch(r7) {
		...
		case 1:
			...
			r14 = hl_to_virtual(&t$vrt_f6fd8f3,(vdynamic*)r4);
			if( r14 == NULL ) hl_null_access();
			r9 = hl_vfields(r14)[1] ? (*(hl__types__ArrayObj*)(hl_vfields(r14)[1])) : (hl__types__ArrayObj)hl_dyn_getp(r14->value,-149576751/*hittable*/,&t$hl_types_ArrayObj);
			if( r9 == NULL ) hl_null_access();
			r12 = hl_types_ArrayObj_remove(r9,((vdynamic*)r1));
			goto label$e6f4f97_5_46;
		case 2:
			...
			r14 = hl_to_virtual(&t$vrt_f6fd8f3,(vdynamic*)r4);
			if( r14 == NULL ) hl_null_access();
			r9 = hl_vfields(r14)[2] ? (*(hl__types__ArrayObj*)(hl_vfields(r14)[2])) : (hl__types__ArrayObj)hl_dyn_getp(r14->value,332491895/*nonColliders*/,&t$hl_types_ArrayObj);
			if( r9 == NULL ) hl_null_access();
			r12 = hl_types_ArrayObj_remove(r9,((vdynamic*)r1));
	}
	label$e6f4f97_5_46:

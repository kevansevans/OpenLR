...
void hxd_System_reportError(vdynamic* r0) {
	...
	goto label$7609c18_9_11;
	label$7609c18_9_10:
	r7 = haxe__CallStack_CallStack_Impl__exceptionStack();
	label$7609c18_9_11:
	r6 = haxe__CallStack_CallStack_Impl__toString(r7);
	hl_trap(trap$0,r1,label$7609c18_9_17);
	r9 = Std_string(r0);
	r8 = r9;
	hl_endtrap(trap$0);
	goto label$7609c18_9_20;
	label$7609c18_9_17:
	r10 = NULL;
	r9 = (String)s$e94f0bf;
	r8 = r9;
	...
	r9 = String___add__(r9,r6);
	r12 = (String)s$68b329d;
	r9 = String___add__(r9,r12);
	r13 = NULL;
	haxe_io_Output_writeString(r11,r9,r13);
	r9 = Sys_systemName();
	r12 = (String)s$Windows;
	if( r9 == r12 || (r9 && r12 && String___compare(r9,(vdynamic*)r12) == 0) ) goto label$7609c18_9_31;
	return;
	label$7609c18_9_31:
	r14 = (hxd__$System)g$_hxd_System;
	r4 = r14->dismissErrors;
	if( !r4 ) goto label$7609c18_9_35;
	return;
	label$7609c18_9_35:
	r15 = (hl__WinLog)hl_alloc_obj(&t$hl_WinLog);
	r9 = (String)s$Uncaught_Exception;
	r16 = 500;
	r17 = 400;
	hl_WinLog_new(r15,r9,r16,r17);
	r12 = (String)s$68b329d;
	r9 = String___add__(r8,r12);
	r9 = String___add__(r9,r6);
	r18 = NULL;
	hl_WinLog_setTextContent(r15,r9,r18);
	r19 = (hl__Button)hl_alloc_obj(&t$hl_Button);
	r9 = (String)s$Continue;
	hl_Button_new(r19,((hl__Window)r15),r9);
	r21 = &cl$0;
	r19->onClick = r21;
	r20 = (hl__Button)hl_alloc_obj(&t$hl_Button);
	r9 = (String)s$Dismiss_all;
	hl_Button_new(r20,((hl__Window)r15),r9);
	r21 = &cl$1;
	r20->onClick = r21;
	r22 = (hl__Button)hl_alloc_obj(&t$hl_Button);
	r9 = (String)s$Exit;
	hl_Button_new(r22,((hl__Window)r15),r9);
	r21 = &cl$2;
	r22->onClick = r21;
	label$7609c18_9_60:
	r4 = true;
	r16 = ui_ui_loop(r4);
	r17 = 2;
	if( r16 == r17 ) goto label$7609c18_9_67;
	hxd_System_timeoutTick();
	goto label$7609c18_9_60;
	label$7609c18_9_67:
	if( r15 == NULL ) hl_null_access();
	hl_Window_destroy(((hl__Window)r15));
	return;
}

...
String components_stage_LRConsole_handleCommand__$1(venum* r0,String r1) {
	...
	r5 = 0;
	r6 = r4->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$a3ed764_3_9;
	r5 = 0;
	goto label$a3ed764_3_13;
	label$a3ed764_3_9:
	r7 = r4->bytes;
	r6 = 2;
	r6 = r5 << r6;
	...
	r6 = r8->length;
	if( r5 >= r6 ) goto label$a3ed764_3_77;
	...
	r6 = 0;
	r10 = r4->length;
	if( ((unsigned)r6) < ((unsigned)r10) ) goto label$a3ed764_3_28;
	...
	*(int*)(r7 + r10) = r11;
	...
	r6 = r9->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$a3ed764_3_38;
	...
	r5 = 0;
	r6 = r9->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$a3ed764_3_47;
	r8 = NULL;
	goto label$a3ed764_3_50;
	label$a3ed764_3_47:
	r12 = r9->array;
	r13 = ((vdynamic**)(r12 + 1))[r5];
	r8 = (String)r13;
	label$a3ed764_3_50:
	if( r8 != r1 && (!r8 || !r1 || String___compare(r8,(vdynamic*)r1) != 0) ) goto label$a3ed764_3_64;
	r4 = ((Enumt$ctx_c92cbb3*)r0)->p2;
	if( r4 == NULL ) hl_null_access();
	r5 = 0;
	r6 = r4->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$a3ed764_3_57;
	...
	*(int*)(r7 + r6) = r10;
	...
	r5 = 0;
	r6 = r9->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$a3ed764_3_71;
	r14 = NULL;
	goto label$a3ed764_3_74;
	label$a3ed764_3_71:
	r12 = r9->array;
	r13 = ((vdynamic**)(r12 + 1))[r5];
	r14 = (String)r13;
...
void components_stage_LRConsole_handleCommand(components__stage__LRConsole r0,String r1) {
	...
	r6->v.i = r5;
	if( r4 != r6 && (!r4 || !r6 || (r4->v.i != r6->v.i)) ) goto label$a3ed764_4_12;
	r5 = 1;
	r4 = NULL;
	...
	label$a3ed764_4_12:
	r7 = (String)s$;
	if( r2 != r7 && (!r2 || !r7 || String___compare(r2,(vdynamic*)r7) != 0) ) goto label$a3ed764_4_16;
	...
	*(int*)(r15 + r17) = r16;
	...
	r12 = 0;
	r16 = r14->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_56;
	r12 = 0;
	goto label$a3ed764_4_60;
	label$a3ed764_4_56:
	r15 = r14->bytes;
	r16 = 2;
	r16 = r12 << r16;
	...
	if( r1 == NULL ) hl_null_access();
	r16 = r1->length;
	if( r12 >= r16 ) goto label$a3ed764_4_308;
	if( r13 == NULL ) hl_null_access();
	r12 = 0;
	r16 = 0;
	r17 = r14->length;
	if( ((unsigned)r16) < ((unsigned)r17) ) goto label$a3ed764_4_70;
	r16 = 0;
	...
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_78;
	...
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_85;
	r7 = NULL;
	goto label$a3ed764_4_88;
	label$a3ed764_4_85:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r7 = (String)r8;
	label$a3ed764_4_88:
	if( !r7 ) goto label$a3ed764_4_97;
	r12 = r7->length;
	r16 = 1;
	if( r12 != r16 ) goto label$a3ed764_4_97;
	r15 = r7->bytes;
	r21 = (vbyte*)USTR("\t");
	r12 = hl_string_compare(r15,r21,r12);
	r16 = 0;
	if( r12 == r16 ) goto label$a3ed764_4_135;
	label$a3ed764_4_97:
	if( !r7 ) goto label$a3ed764_4_106;
	r12 = r7->length;
	r16 = 1;
	if( r12 != r16 ) goto label$a3ed764_4_106;
	r15 = r7->bytes;
	r21 = (vbyte*)USTR(" ");
	r12 = hl_string_compare(r15,r21,r12);
	r16 = 0;
	if( r12 == r16 ) goto label$a3ed764_4_135;
	label$a3ed764_4_106:
	if( !r7 ) goto label$a3ed764_4_115;
	r12 = r7->length;
	r16 = 1;
	if( r12 != r16 ) goto label$a3ed764_4_115;
	r15 = r7->bytes;
	r21 = (vbyte*)USTR("\"");
	r12 = hl_string_compare(r15,r21,r12);
	r16 = 0;
	if( r12 == r16 ) goto label$a3ed764_4_209;
	label$a3ed764_4_115:
	if( !r7 ) goto label$a3ed764_4_124;
	r12 = r7->length;
	r16 = 1;
	if( r12 != r16 ) goto label$a3ed764_4_124;
	r15 = r7->bytes;
	r21 = (vbyte*)USTR("'");
	r12 = hl_string_compare(r15,r21,r12);
	r16 = 0;
	...
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_129;
	r22 = NULL;
	goto label$a3ed764_4_132;
	label$a3ed764_4_129:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r22 = (String)r8;
	...
	r2 = r7;
	goto label$a3ed764_4_297;
	label$a3ed764_4_135:
	r12 = 0;
	r16 = 0;
	r17 = r14->length;
	if( ((unsigned)r16) < ((unsigned)r17) ) goto label$a3ed764_4_141;
	r16 = 0;
	goto label$a3ed764_4_145;
	label$a3ed764_4_141:
	r15 = r14->bytes;
	r17 = 2;
	r17 = r16 << r17;
	...
	r7 = String_charAt(r1,r16);
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_149;
	hl_types_ArrayObj___expand(r13,r12);
	label$a3ed764_4_149:
	r10 = r13->array;
	((String*)(r10 + 1))[r12] = r7;
	...
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_158;
	r7 = NULL;
	goto label$a3ed764_4_161;
	label$a3ed764_4_158:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r7 = (String)r8;
	...
	if( r7 == r22 || (r7 && r22 && String___compare(r7,(vdynamic*)r22) == 0) ) goto label$a3ed764_4_173;
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_168;
	r7 = NULL;
	goto label$a3ed764_4_171;
	label$a3ed764_4_168:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r7 = (String)r8;
	...
	if( r7 != r22 && (!r7 || !r22 || String___compare(r7,(vdynamic*)r22) != 0) ) goto label$a3ed764_4_193;
	label$a3ed764_4_173:
	r12 = 0;
	if( r1 == NULL ) hl_null_access();
	if( r14 == NULL ) hl_null_access();
	r16 = 0;
	r17 = r14->length;
	if( ((unsigned)r16) < ((unsigned)r17) ) goto label$a3ed764_4_180;
	...
	*(int*)(r15 + r17) = r23;
	...
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_190;
	hl_types_ArrayObj___expand(r13,r12);
	label$a3ed764_4_190:
	r10 = r13->array;
	((String*)(r10 + 1))[r12] = r7;
	goto label$a3ed764_4_151;
	label$a3ed764_4_193:
	if( r14 == NULL ) hl_null_access();
	r12 = 0;
	r16 = r14->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_198;
	...
	*(int*)(r15 + r16) = r17;
	...
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_215;
	r7 = NULL;
	goto label$a3ed764_4_218;
	label$a3ed764_4_215:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r7 = (String)r8;
	...
	if( r7 ) goto label$a3ed764_4_224;
	...
	r16 = 0;
	r17 = r14->length;
	if( ((unsigned)r16) < ((unsigned)r17) ) goto label$a3ed764_4_234;
	r16 = 0;
	goto label$a3ed764_4_238;
	label$a3ed764_4_234:
	r15 = r14->bytes;
	r17 = 2;
	r17 = r16 << r17;
	...
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_242;
	hl_types_ArrayObj___expand(r13,r12);
	label$a3ed764_4_242:
	r10 = r13->array;
	...
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_251;
	r22 = NULL;
	goto label$a3ed764_4_254;
	label$a3ed764_4_251:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r22 = (String)r8;
	...
	if( r22 == r24 || (r22 && r24 && String___compare(r22,(vdynamic*)r24) == 0) ) goto label$a3ed764_4_266;
	r12 = 0;
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_261;
	r22 = NULL;
	goto label$a3ed764_4_264;
	label$a3ed764_4_261:
	r10 = r13->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r22 = (String)r8;
	...
	if( r22 != r24 && (!r22 || !r24 || String___compare(r22,(vdynamic*)r24) != 0) ) goto label$a3ed764_4_286;
	label$a3ed764_4_266:
	r12 = 0;
	if( r1 == NULL ) hl_null_access();
	if( r14 == NULL ) hl_null_access();
	r16 = 0;
	r17 = r14->length;
	if( ((unsigned)r16) < ((unsigned)r17) ) goto label$a3ed764_4_273;
	hl_types_ArrayBytes_Int___expand(r14,r16);
	label$a3ed764_4_273:
	r15 = r14->bytes;
	r17 = 2;
	...
	*(int*)(r15 + r17) = r23;
	...
	r16 = r13->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_283;
	hl_types_ArrayObj___expand(r13,r12);
	label$a3ed764_4_283:
	r10 = r13->array;
	((String*)(r10 + 1))[r12] = r22;
	goto label$a3ed764_4_244;
	label$a3ed764_4_286:
	if( r14 == NULL ) hl_null_access();
	r12 = 0;
	r16 = r14->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_291;
	hl_types_ArrayBytes_Int___expand(r14,r12);
	label$a3ed764_4_291:
	r15 = r14->bytes;
	r16 = 2;
	...
	*(int*)(r15 + r16) = r17;
	...
	r12 = 0;
	r16 = r14->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_301;
	hl_types_ArrayBytes_Int___expand(r14,r12);
	label$a3ed764_4_301:
	r15 = r14->bytes;
	r16 = 2;
	...
	++r17;
	*(int*)(r15 + r16) = r17;
	goto label$a3ed764_4_49;
	label$a3ed764_4_308:
	if( r9 == NULL ) hl_null_access();
	r12 = hl_types_ArrayObj_push(r9,((vdynamic*)r2));
	r12 = 0;
	r16 = r9->length;
	if( ((unsigned)r12) < ((unsigned)r16) ) goto label$a3ed764_4_315;
	r7 = NULL;
	goto label$a3ed764_4_318;
	label$a3ed764_4_315:
	r10 = r9->array;
	r8 = ((vdynamic**)(r10 + 1))[r12];
	r7 = (String)r8;
	...
	if( !r25 ) goto label$a3ed764_4_327;
	r26 = r0->aliases;
	if( r26 == NULL ) hl_null_access();
	...
	if( r27 ) goto label$a3ed764_4_339;
	...
	r16 = r20->length;
	label$a3ed764_4_346:
	if( r12 >= r16 ) goto label$a3ed764_4_539;
	r17 = r12;
	++r12;
	if( r27 == NULL ) hl_null_access();
	r20 = hl_vfields(r27)[0] ? (*(hl__types__ArrayObj*)(hl_vfields(r27)[0])) : (hl__types__ArrayObj)hl_dyn_getp(r27->value,7638631/*args*/,&t$hl_types_ArrayObj);
	if( r20 == NULL ) hl_null_access();
	r29 = r20->length;
	if( ((unsigned)r17) < ((unsigned)r29) ) goto label$a3ed764_4_357;
	r30 = NULL;
	goto label$a3ed764_4_360;
	label$a3ed764_4_357:
	r10 = r20->array;
	...
	switch(r23) {
		default:
			goto label$a3ed764_4_538;
		case 0:
			r4 = Std_parseInt(r22);
			if( r4 ) goto label$a3ed764_4_402;
			r24 = (String)s$;
		...
		case 1:
			...
			if( !r25 ) goto label$a3ed764_4_417;
			r24 = (String)s$;
			r24 = String___add__(r24,r22);
		...
		case 2:
			...
			r23 = r20->length;
			r29 = 1;
			if( r23 != r29 ) goto label$a3ed764_4_443;
			if( r1 == NULL ) hl_null_access();
			r23 = 0;
			r29 = r9->length;
			if( ((unsigned)r23) < ((unsigned)r29) ) goto label$a3ed764_4_433;
			r32 = NULL;
			goto label$a3ed764_4_436;
			label$a3ed764_4_433:
			r10 = r9->array;
			r8 = ((vdynamic**)(r10 + 1))[r23];
			r32 = (String)r8;
			...
			goto label$a3ed764_4_538;
		case 3:
			if( !r22 ) goto label$a3ed764_4_455;
			r23 = r22->length;
			r29 = 1;
			if( r23 != r29 ) goto label$a3ed764_4_455;
			r15 = r22->bytes;
			r21 = (vbyte*)USTR("1");
			r23 = hl_string_compare(r15,r21,r23);
			r29 = 0;
			if( r23 == r29 ) goto label$a3ed764_4_491;
			label$a3ed764_4_455:
			if( !r22 ) goto label$a3ed764_4_464;
			r23 = r22->length;
			r29 = 4;
			if( r23 != r29 ) goto label$a3ed764_4_464;
			r15 = r22->bytes;
			r21 = (vbyte*)USTR("true");
			r23 = hl_string_compare(r15,r21,r23);
			r29 = 0;
			if( r23 == r29 ) goto label$a3ed764_4_491;
			label$a3ed764_4_464:
			if( !r22 ) goto label$a3ed764_4_473;
			r23 = r22->length;
			r29 = 1;
			if( r23 != r29 ) goto label$a3ed764_4_473;
			r15 = r22->bytes;
			r21 = (vbyte*)USTR("0");
			r23 = hl_string_compare(r15,r21,r23);
			r29 = 0;
			if( r23 == r29 ) goto label$a3ed764_4_496;
			label$a3ed764_4_473:
			if( !r22 ) goto label$a3ed764_4_482;
			r23 = r22->length;
			r29 = 5;
			if( r23 != r29 ) goto label$a3ed764_4_482;
			r15 = r22->bytes;
		...
		case 4:
			...
			if( r20 == NULL ) hl_null_access();
			r35 = r20->length;
			if( r23 >= r35 ) goto label$a3ed764_4_522;
			r35 = r20->length;
			if( ((unsigned)r23) < ((unsigned)r35) ) goto label$a3ed764_4_512;
			r24 = NULL;
			goto label$a3ed764_4_515;
			label$a3ed764_4_512:
			r10 = r20->array;
			r8 = ((vdynamic**)(r10 + 1))[r23];
			r24 = (String)r8;
			label$a3ed764_4_515:
			++r23;
			if( r22 != r24 && (!r22 || !r24 || String___compare(r22,(vdynamic*)r24) != 0) ) goto label$a3ed764_4_521;
			r36 = true;
			r25 = r36;
			if( r28 == NULL ) hl_null_access();
			r29 = hl_types_ArrayDyn_push(r28,((vdynamic*)r24));
			label$a3ed764_4_521:
			goto label$a3ed764_4_504;
			label$a3ed764_4_522:
			if( r25 ) goto label$a3ed764_4_538;
			r24 = (String)s$;
			r24 = String___add__(r24,r22);
	...
	goto label$a3ed764_4_346;
	label$a3ed764_4_539:
	hl_trap(trap$0,r8,label$a3ed764_4_546);
	r8 = NULL;
	if( r27 == NULL ) hl_null_access();
	...
	if( !r25 ) goto label$a3ed764_4_559;

...
void components_stage_Canvas_redrawLines(components__stage__Canvas r0,int r1) {
	...
	switch(r1) {
		default:
			goto label$ae2bdbd_5_15;
		case 0:
		case 1:
			r4 = r0->rideLayer;
			if( r4 == NULL ) hl_null_access();
			h2d_Graphics_clear(r4);
			r4 = r0->colorLayer;
			if( r4 == NULL ) hl_null_access();
			h2d_Graphics_clear(r4);
			goto label$ae2bdbd_5_15;
		case 2:
			r4 = r0->sceneColorLayer;
			if( r4 == NULL ) hl_null_access();
			h2d_Graphics_clear(r4);
	...
	if( r5 == NULL ) hl_null_access();
	r8 = r5->length;
	if( r3 >= r8 ) goto label$ae2bdbd_5_36;
	r8 = r5->length;
	if( ((unsigned)r3) < ((unsigned)r8) ) goto label$ae2bdbd_5_28;
	r9 = NULL;
	goto label$ae2bdbd_5_31;
	label$ae2bdbd_5_28:
	r11 = r5->array;
	...
	goto label$ae2bdbd_5_20;
	label$ae2bdbd_5_34:
	components_stage_Canvas_drawLineGraphic(r0,r9);
	goto label$ae2bdbd_5_20;
	label$ae2bdbd_5_36:
	return;
}
...
void components_stage_Canvas_addLine(components__stage__Canvas r0,int r1,double r2,double r3,double r4,double r5,vdynamic* r6,vdynamic* r7) {
	components__managers__Grid r31;
	bool r8;
	components__lines__Floor r12;
	$Main r32;
	h2d__col__Point r13, r18;
	components__lines__LineBase r10;
	double r14, r16, r19, r20, r22, r23, r24, r25, r27, r28, r29, r30;
	components__lines__Scenery r26;
	double *r15, *r17;
	components__lines__Accel r21;
	int r9;
	if( r6 ) goto label$ae2bdbd_8_3;
	r8 = false;
	r6 = hl_alloc_dynbool(r8);
	label$ae2bdbd_8_3:
	if( r7 ) goto label$ae2bdbd_8_6;
	r9 = -1;
	...
	switch(r1) {
		...
		case 0:
			...
			goto label$ae2bdbd_8_59;
		case 1:
			r21 = (components__lines__Accel)hl_alloc_obj(&t$components_lines_Accel);
			r13 = (h2d__col__Point)hl_alloc_obj(&t$h2d_col_Point);
			r22 = r2;
			r15 = &r22;
			r23 = r3;
			...
			h2d_col_Point_new(r18,r15,r17);
			r8 = r6 ? r6->v.b : 0;
			components_lines_Accel_new(r21,r13,r18,r8);
			r10 = ((components__lines__LineBase)r21);
			goto label$ae2bdbd_8_59;
		case 2:
			r26 = (components__lines__Scenery)hl_alloc_obj(&t$components_lines_Scenery);
			r13 = (h2d__col__Point)hl_alloc_obj(&t$h2d_col_Point);
			r27 = r2;
			r15 = &r27;
			r28 = r3;
			...
			h2d_col_Point_new(r18,r15,r17);
			r8 = r6 ? r6->v.b : 0;
			components_lines_Scenery_new(r26,r13,r18,r8);
			r10 = ((components__lines__LineBase)r26);
	}
	label$ae2bdbd_8_59:
	components_stage_Canvas_drawLineGraphic(r0,r10);
	r32 = ($Main)g$_Main;
	r31 = r32->grid;
	if( r31 == NULL ) hl_null_access();
	components_managers_Grid_register(r31,r10);
	return;
}

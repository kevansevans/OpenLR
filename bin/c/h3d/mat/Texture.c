...
h3d__mat__Texture h3d_mat_Texture_fromColor(int r0,vdynamic* r1) {
	...
	r6 = (int)r2;
	r9 = 0;
	if( r6 >= r9 ) goto label$3bd692e_22_14;
	r8 = 0;
	r6 = r8;
	goto label$3bd692e_22_18;
	label$3bd692e_22_14:
	r9 = 255;
	if( r9 >= r6 ) goto label$3bd692e_22_18;
	r8 = 255;
	r6 = r8;
	label$3bd692e_22_18:
	r9 = 16777215;
	...
	if( !r13 ) goto label$3bd692e_22_30;
	return r13;
	label$3bd692e_22_30:
	...
	if( r1 ) goto label$3bd692e_22_39;
	r17 = NULL;
	goto label$3bd692e_22_41;
	label$3bd692e_22_39:
	r2 = r1 ? r1->v.d : 0;
	r17 = &r2;
	label$3bd692e_22_41:
...
h3d__mat__Texture h3d_mat_Texture_defaultCubeTexture() {
	...
	if( !r6 ) goto label$3bd692e_24_10;
	return r6;
	label$3bd692e_24_10:
...
void h3d_mat_Texture_new(h3d__mat__Texture r0,int r1,int r2,hl__types__ArrayObj r3,venum* r4) {
	...
	r9 = r6->mem;
	r0->mem = r9;
	if( r4 ) goto label$3bd692e_25_11;
	...
	r12 = 0;
	r0->flags = r12;
	if( !r3 ) goto label$3bd692e_25_41;
	r13 = 0;
	label$3bd692e_25_21:
	if( r3 == NULL ) hl_null_access();
	r15 = r3->length;
	if( r13 >= r15 ) goto label$3bd692e_25_41;
	r15 = r3->length;
	if( ((unsigned)r13) < ((unsigned)r15) ) goto label$3bd692e_25_29;
	r16 = NULL;
	goto label$3bd692e_25_32;
	label$3bd692e_25_29:
	r18 = r3->array;
	...
	r14 = r14 | r15;
	r0->flags = r14;
	goto label$3bd692e_25_21;
	label$3bd692e_25_41:
	r13 = 1;
	r14 = 1;
	label$3bd692e_25_43:
	if( r13 >= r1 ) goto label$3bd692e_25_49;
	r19 = 1;
	r15 = r13 << r19;
	r13 = r15;
	goto label$3bd692e_25_43;
	label$3bd692e_25_49:
	if( r14 >= r2 ) goto label$3bd692e_25_55;
	r19 = 1;
	r15 = r14 << r19;
	r14 = r15;
	goto label$3bd692e_25_49;
	label$3bd692e_25_55:
	if( r13 != r1 ) goto label$3bd692e_25_57;
	if( r14 == r2 ) goto label$3bd692e_25_61;
	label$3bd692e_25_57:
	r15 = r0->flags;
	r19 = 16;
	r15 = r15 | r19;
	...
	r15 = r15 & r19;
	r19 = 0;
	if( r15 == r19 ) goto label$3bd692e_25_68;
	r20 = &cl$0;
	r0->realloc = r20;
	label$3bd692e_25_68:
	r0->width = r1;
	...
	r15 = r15 & r19;
	r19 = 0;
	if( r15 == r19 ) goto label$3bd692e_25_77;
	...
	r15 = r15 & r19;
	r19 = 0;
	if( r15 != r19 ) goto label$3bd692e_25_93;
	h3d_mat_Texture_alloc(r0);
	label$3bd692e_25_93:
	return;
}

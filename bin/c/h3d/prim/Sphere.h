...
#ifndef INC_h3d__prim__Sphere
#define INC_h3d__prim__Sphere
typedef struct _h3d__prim__$Sphere *h3d__prim__$Sphere;
typedef struct _h3d__prim__Sphere *h3d__prim__Sphere;
#include <hl/Class.h>

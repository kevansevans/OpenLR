...
void h3d_pass_Copy_run(h3d__mat__Texture r0,h3d__mat__Texture r1,venum* r2,h3d__mat__Pass r3,vdynamic* r4) {
	...
	r5 = r6->CURRENT;
	if( !r1 ) goto label$99e63e8_3_14;
	if( !r0 ) goto label$99e63e8_3_14;
	if( !r2 ) goto label$99e63e8_3_7;
	r8 = (venum*)g$h2d_BlendMode_None;
	if( r2 != r8 ) goto label$99e63e8_3_14;
	label$99e63e8_3_7:
	if( r3 ) goto label$99e63e8_3_14;
	if( r5 == NULL ) hl_null_access();
	r10 = r5->driver;
	if( r10 == NULL ) hl_null_access();
	r9 = h3d_impl_Driver_copyTexture(r10,r0,r1);
	if( !r9 ) goto label$99e63e8_3_14;
	return;
	label$99e63e8_3_14:
	if( r5 == NULL ) hl_null_access();
	r12 = r5->resCache;
	...
	if( r14 ) goto label$99e63e8_3_28;

...
#ifndef INC_h3d__scene__fwd__DepthPass
#define INC_h3d__scene__fwd__DepthPass
typedef struct _h3d__scene__fwd__$DepthPass *h3d__scene__fwd__$DepthPass;
typedef struct _h3d__scene__fwd__DepthPass *h3d__scene__fwd__DepthPass;
#include <hl/Class.h>
...
struct _h3d__scene__fwd__$DepthPass {
	hl_type *$type;
	hl_type* __type__;
	vdynamic* __meta__;
...
struct _h3d__scene__fwd__DepthPass {
	hl_type *$type;

...
void h3d_scene_Skin_syncJoints(h3d__scene__Skin r0) {
	...
	bool r2;
	h3d__shader__SkinBase r45;
	h3d__anim__Skin r6;
	double r17, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43;
	vdynamic *r3;
	h3d__Matrix r14, r15, r16, r18;
	varray *r11;
	int r4, r7, r8, r13, r44;
	r2 = r0->jointsUpdated;
	...
	r8 = r5->length;
	if( r4 >= r8 ) goto label$1bc97f3_5_417;
	r8 = r5->length;
	if( ((unsigned)r4) < ((unsigned)r8) ) goto label$1bc97f3_5_15;
	r10 = NULL;
	goto label$1bc97f3_5_18;
	label$1bc97f3_5_15:
	r11 = r5->array;
	...
	if( r9 == NULL ) hl_null_access();
	r13 = r9->length;
	if( ((unsigned)r7) < ((unsigned)r13) ) goto label$1bc97f3_5_27;
	r14 = NULL;
	goto label$1bc97f3_5_30;
	label$1bc97f3_5_27:
	r11 = r9->array;
	...
	if( r9 == NULL ) hl_null_access();
	r13 = r9->length;
	if( ((unsigned)r7) < ((unsigned)r13) ) goto label$1bc97f3_5_36;
	r15 = NULL;
	goto label$1bc97f3_5_39;
	label$1bc97f3_5_36:
	r11 = r9->array;
	r3 = ((vdynamic**)(r11 + 1))[r7];
	r15 = (h3d__Matrix)r3;
	label$1bc97f3_5_39:
	r8 = r10->bindIndex;
	if( r15 ) goto label$1bc97f3_5_44;
	r16 = r10->defMat;
	r15 = r16;
	goto label$1bc97f3_5_59;
	label$1bc97f3_5_44:
	r2 = r10->retargetAnim;
	if( !r2 ) goto label$1bc97f3_5_59;
	...
	label$1bc97f3_5_59:
	r12 = r10->parent;
	if( r12 ) goto label$1bc97f3_5_173;
	r16 = r0->absPos;
	if( r15 == NULL ) hl_null_access();
	r17 = r15->_11;
	r19 = r15->_12;
	...
	r13 = r12->index;
	r44 = r9->length;
	if( ((unsigned)r13) < ((unsigned)r44) ) goto label$1bc97f3_5_182;
	r16 = NULL;
	goto label$1bc97f3_5_185;
	label$1bc97f3_5_182:
	r11 = r9->array;
	...
	label$1bc97f3_5_295:
	r44 = 0;
	if( r8 < r44 ) goto label$1bc97f3_5_416;
	r9 = r0->currentPalette;
	if( r9 == NULL ) hl_null_access();
	r44 = r9->length;
	if( ((unsigned)r8) < ((unsigned)r44) ) goto label$1bc97f3_5_303;
	r16 = NULL;
	goto label$1bc97f3_5_306;
	label$1bc97f3_5_303:
	r11 = r9->array;
	...
	r16->_44 = r42;
	label$1bc97f3_5_416:
	goto label$1bc97f3_5_7;
	label$1bc97f3_5_417:
	r45 = r0->skinShader;
	if( r45 == NULL ) hl_null_access();
	r5 = r0->currentPalette;
	r45->bonesMatrixes__ = r5;
	r14 = r0->jointsAbsPosInv;
	if( !r14 ) goto label$1bc97f3_5_427;
	r14 = r0->jointsAbsPosInv;
	if( r14 == NULL ) hl_null_access();
	r17 = 0.;
	r14->_44 = r17;

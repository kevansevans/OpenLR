...
hl__types__ArrayObj haxe__CallStack_CallStack_Impl__exceptionStack(bool* r0) {
	hl__types__ArrayObj r2, r5, r6;
	bool r1;
	int *r4;
	varray *r3;
	if( r0 ) goto label$e26c8ce_2_3;
	r1 = false;
	goto label$e26c8ce_2_4;
	label$e26c8ce_2_3:
	r1 = *r0;
	label$e26c8ce_2_4:
	r3 = hl_exception_stack();
	r4 = NULL;
	r2 = haxe_NativeStackTrace_toHaxe(r3,r4);
	if( !r1 ) goto label$e26c8ce_2_10;
	r5 = r2;
	goto label$e26c8ce_2_12;
	label$e26c8ce_2_10:
	r6 = haxe__CallStack_CallStack_Impl__callStack();
	r5 = haxe__CallStack_CallStack_Impl__subtract(r2,r6);
	label$e26c8ce_2_12:
	return r5;
}
